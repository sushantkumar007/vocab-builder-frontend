...
function Navbar() {
  ...
  return (
    <nav className="">
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between p-4 md:px-8 lg:px-16">
        <div>
          <Link
            to="/"
        ...
        {!isLoggedIn && (
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              className="hidden px-4 py-4 md:flex rounded-sm"
              onClick={() => navigate("/login")}
            >
              Login
            </Button>
            <Button
              className="hidden px-4 py-2 md:flex rounded-sm"
        ...
        <Sheet>
          ...
          {isLoggedIn && (
            <SheetTrigger
              ...
              render={
                <Button className="hidden px-4 md rounded-sm">Menu</Button>
              }
            />
          )}
